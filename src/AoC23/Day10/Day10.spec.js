...
describe('Day10', () => {
  ...
  describe.skip('partTwo', () => {
    it('Returns the number of tiles enclosed by the loop for grid C', async () => {
      const actual = await partTwo(mockDataC);
      expect(actual).toEqual(4);
    });
    it('Returns the number of tiles enclosed by the loop for grid D', async () => {
      const actual = await partTwo(mockDataD);
      expect(actual).toEqual(8);
    });
    it('Returns the number of tiles enclosed by the loop for grid E', async () => {
      const actual = await partTwo(mockDataE);
